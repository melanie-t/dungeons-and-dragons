	...
	while (chestPopup.isOpen() && chestPopup.isOpen())
	{
		...
		while (chestPopup.pollEvent(event))
		{
			...
			switch (inputItem.getItemType()) {
				case 1: item.loadFromFile("res/armor2.png");
				case 2: item.loadFromFile("res/belt2.png");
				case 3: item.loadFromFile("res/helmet2.png");
				case 4: item.loadFromFile("res/ring2.png");
				case 5: item.loadFromFile("res/shield2.png");
				case 6: item.loadFromFile("res/boots2.png");
				case 7: item.loadFromFile("res/sword.png");
			}
